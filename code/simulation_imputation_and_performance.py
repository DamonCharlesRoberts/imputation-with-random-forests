...
sns.kdeplot(data = sim_10_mice_comp_1, x = 'ColumnF', linestyle = 'solid', color = '#e6e6e6')
sns.kdeplot(data = sim_10_mice_comp_2, x = 'ColumnF', linestyle = 'solid', color = '#d9d9d9')
sns.kdeplot(data = sim_10_mice_comp_3, x = 'ColumnF', linestyle = 'solid', color = '#bfbfbf')
sns.kdeplot(data = sim_10_mice_comp_4, x = 'ColumnF', linestyle = 'solid', color = '#b3b3b3')
sns.kdeplot(data = sim_10_mice_comp_5, x = 'ColumnF', linestyle = 'solid', color = '#a6a6a6')
sns.kdeplot(data = sim_10_mice_comp_6, x = 'ColumnF', linestyle = 'solid', color = '#999999')
sns.kdeplot(data = sim_10_mice_comp_7, x = 'ColumnF', linestyle = 'solid', color = '#8c8c8c')
sns.kdeplot(data = sim_10_mice_comp_8, x = 'ColumnF', linestyle = 'solid', color = '#808080')
sns.kdeplot(data = sim_10_mice_comp_9, x = 'ColumnF', linestyle = 'solid', color = '#404040')
sns.kdeplot(data = sim_10_mice_comp_10, x = 'ColumnF', linestyle = 'solid', color = '#000000')
plt.subplot(1,2,2)
...
sns.kdeplot(data = sim_10_mice_comp_1, x = 'ColumnC', linestyle = 'solid', color = '#e6e6e6')
sns.kdeplot(data = sim_10_mice_comp_2, x = 'ColumnC', linestyle = 'solid', color = '#d9d9d9')
sns.kdeplot(data = sim_10_mice_comp_3, x = 'ColumnC', linestyle = 'solid', color = '#bfbfbf')
sns.kdeplot(data = sim_10_mice_comp_4, x = 'ColumnC', linestyle = 'solid', color = '#b3b3b3')
sns.kdeplot(data = sim_10_mice_comp_5, x = 'ColumnC', linestyle = 'solid', color = '#a6a6a6')
sns.kdeplot(data = sim_10_mice_comp_6, x = 'ColumnC', linestyle = 'solid', color = '#999999')
sns.kdeplot(data = sim_10_mice_comp_7, x = 'ColumnC', linestyle = 'solid', color = '#8c8c8c')
sns.kdeplot(data = sim_10_mice_comp_8, x = 'ColumnC', linestyle = 'solid', color = '#808080')
sns.kdeplot(data = sim_10_mice_comp_9, x = 'ColumnC', linestyle = 'solid', color = '#404040')
sns.kdeplot(data = sim_10_mice_comp_10, x = 'ColumnC', linestyle = 'solid', color = '#000000')
